...
public class AppTest {
    ...
    public void shouldDig() throws Exception {
        ...
        managerCliente.procesarMensajeCliente();
        clienteJuego1.procesarMensajeServidor();
        // El otro cliente también recibe la actualización de buscados
        clienteJuego2.procesarMensajeServidor();

        assertEquals(1, clienteJuego1.estado.buscadas.size());
        assertEquals(1, clienteJuego2.estado.buscadas.size());
        assertEquals(1, servidorJuego.estado.buscadas.size());
